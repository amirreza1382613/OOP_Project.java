...
public class SignIn {
    ...
    public static void signIn(SignInSituation situation) {
        UI.clearScreen();
        ...
        switch (situation) {
            ...
            SignInController.signinbuglabel="username does not exists";
                break;}
            case WRONG_PASSWORD:{
                System.out.println("wrong password\n");
                SignInController.signinbuglabel="wrong password";
                break;}
            case DATA_BASE:{
                System.out.println("oops! we have some problem in connection :(\n" +
                        "please try again\n");
                SignInController.signinbuglabel="oops! we have some problem in connection :(,please try again";
                try {
